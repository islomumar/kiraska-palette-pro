          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-6 text-center lg:text-left">
              <h2 className="text-3xl font-bold text-primary-foreground md:text-4xl lg:text-5xl">
                {getText('cta_title', 'Buyurtma berishga tayyormisiz?')}
              </h2>
              <p className="text-lg text-primary-foreground/80 max-w-lg mx-auto lg:mx-0">
                {getText('cta_description', "Biz bilan bog'laning va professional maslahat oling. Bepul yetkazib berish va qulay to'lov imkoniyatlari.")}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end">
              <Button asChild size="xl" className="rounded-full bg-card text-foreground hover:bg-card/90 shadow-lg">
                <Link to="/products">
                  {getText('cta_btn_order', 'Buyurtma berish')}
              ...
              <Button asChild size="xl" variant="outline" className="rounded-full border-2 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10">
                <a href="tel:+998901234567">
                  ...
                  {getText('cta_btn_call', "Qo'ng'iroq")}
                </a>
              </Button>
            </div>
          </div>
          ...
          <div className="relative z-10 mt-12 grid grid-cols-2 gap-8 md:grid-cols-4 border-t border-primary-foreground/20 pt-8">
            <div className="text-center">
              <p className="text-3xl font-bold text-primary-foreground md:text-4xl">
                {getText('cta_stat_products', '1000+')}
              </p>
              <p className="mt-1 text-sm text-primary-foreground/70">
                {getText('cta_stat_products_label', 'Mahsulotlar')}
              </p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-primary-foreground md:text-4xl">
                {getText('cta_stat_brands', '50+')}
              </p>
              <p className="mt-1 text-sm text-primary-foreground/70">
                {getText('cta_stat_brands_label', 'Brendlar')}
              </p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-primary-foreground md:text-4xl">
                {getText('cta_stat_customers', '5000+')}
              </p>
              <p className="mt-1 text-sm text-primary-foreground/70">
                {getText('cta_stat_customers_label', 'Mamnun mijozlar')}
              </p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-primary-foreground md:text-4xl">
                {getText('cta_stat_experience', '10+')}
              </p>
              <p className="mt-1 text-sm text-primary-foreground/70">
                {getText('cta_stat_experience_label', 'Yillik tajriba')}
              </p>
            </div>
          </div>
        </div>
